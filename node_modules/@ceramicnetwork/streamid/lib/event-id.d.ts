...
export declare type CreateRandomOptionalParams = {
...
export declare class EventID {
    ...
    static createRandom(networkID: number | string, networkIDOffset: number, optionalParams?: CreateRandomOptionalParams): EventID;
    static create(networkID: number | string, networkIDOffset: number, separatorKey: string | Uint8Array, separatorValue: string | Uint8Array, controller: string, init: CID | string, eventHeight: number, event: CID | string): EventID;
