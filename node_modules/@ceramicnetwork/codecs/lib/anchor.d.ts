...
export declare const AnchorCommitPresentation: import("codeco").SparseCodec<{
    cid: import("codeco").Type<import("multiformats/dist/src").CID<unknown, number, number, import("multiformats/dist/src").Version>, string, unknown>;
}>;
...
export declare const NotCompleteCASResponse: import("codeco").SparseCodec<{
    ...
    cid: import("codeco").Type<import("multiformats/dist/src").CID<unknown, number, number, import("multiformats/dist/src").Version>, string, string>;
